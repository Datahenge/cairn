...
| `W-014` | `open` | `DOCS` | `docs/CHANGELOG.md` hit its allowlisted word-count ceiling (2026-08-03) and was bumped 14000→14500 as a stopgap — split it (e.g. archive older dated sections, keep recent history in the main file) during a documentation review session rather than bumping the ceiling again | `.docs_check_allowlist`, `docs/CHANGELOG.md`; see `docs/technical/01-documentation-conventions.md`'s sprawl-control policy |
