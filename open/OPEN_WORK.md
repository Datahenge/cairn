...
| `W-014` | `open` | `DOCS` | `docs/CHANGELOG.md` hit its allowlisted word-count ceiling twice now — bumped 14000→14500 (2026-08-03), then 14500→14550 (2026-08-04, for the `CONFIGURATION.md`-retirement entry). Split it (e.g. archive older dated sections, keep recent history in the main file) during a documentation review session; a third bump should not be the default move | `.docs_check_allowlist`, `docs/CHANGELOG.md`; see `docs/technical/01-documentation-conventions.md`'s sprawl-control policy |
