...
`BR-DEPLOY-010a` says a target is described by `/etc/cairn/environment.toml`. Writing that file
...
def render(found: Survey, environment: str) -> str:
    ...
    lines = [
        "# Generated by `cairn adopt` from the deployment running on this host.",
        "# Review it, then install it as /etc/cairn/environment.toml.",
        "",
