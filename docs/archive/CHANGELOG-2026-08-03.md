...
status: archived
owner: technical
purpose: Archived tail of docs/CHANGELOG.md — dated entries from 2026-08-03.
---

# Changelog archive — 2026-08-03

Relocated from `docs/CHANGELOG.md` on 2026-08-04 to keep that file under its word-count
sprawl limit. Content only — nothing rewritten, nothing summarized. `docs/CHANGELOG.md`
