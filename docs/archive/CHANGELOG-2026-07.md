...
status: archived
owner: technical
purpose: Archived tail of docs/CHANGELOG.md — dated entries from 2026-07-21 through 2026-07-27.
---

# Changelog archive — 2026-07-21 through 2026-07-27

Relocated from `docs/CHANGELOG.md` on 2026-08-04 to keep that file under its
word-count sprawl limit (see `open/OPEN_WORK.md` `W-014`). Content only — nothing
rewritten, nothing summarized. `docs/CHANGELOG.md` carries current entries; this file
is historical-only per `docs/archive/README.md`.
