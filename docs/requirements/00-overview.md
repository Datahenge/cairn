...
| 02 | `BUILD` | `02-build.md` | Custom image build: manifest inputs, ref resolution, invocation, provenance | **approved** |
| 02a | `BUILD` | `02a-build-tagging.md` | Cache-busting, tag scheme, input-hash reuse, ownership marker | **approved** |
